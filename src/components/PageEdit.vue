  ...
  <div class="">
    ...
    >
      ...
      >
        ...
        <div>
          <button class="bg-base-200 p-2 px-5 rounded-xl flex text-sm font-medium gap-2">
            <img src="../assets/icons/visibility.svg" class="" />
            Preview
          </button>
        </div>
      </section>
      ...
      <section class="flex items-center gap-5 h-full px-5">
